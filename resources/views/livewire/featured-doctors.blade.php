        ...
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col p-4 bg-white border border-gray-200 rounded-xl md:p-6 dark:bg-neutral-900 dark:border-neutral-700">
                        <div class="flex items-center gap-x-4">
                            ...
                            <div class="grow">
                                ...
                                <p class="text-xs text-gray-500 uppercase dark:text-neutral-500">
                                    Dermatology / Hospital das Clínicas
                                </p>
                            </div>
                        </div>
                    ...
                    <a class="flex flex-col justify-center p-4 text-center border border-gray-200 border-dashed col-span-full lg:col-span-1 group rounded-xl md:p-6 hover:shadow-sm focus:outline-none focus:shadow-sm dark:border-neutral-700" href="#">
                        <h3 class="text-lg text-gray-800 dark:text-neutral-200">
                            {{ __('Explore More!') }}
                        </h3>
                        <div>
                            <span class="inline-flex items-center text-blue-600 gap-x-2 group-hover:text-blue-700 group-focus:text-blue-700 dark:text-blue-500 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400">
                                {{ __('See all our doctors.') }}
