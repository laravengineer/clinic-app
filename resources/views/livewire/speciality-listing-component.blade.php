        ...
        <div class="p-1.5 min-w-full inline-block align-middle">
          <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700">
            ...
            <div class="grid gap-3 px-6 py-4 border-b border-gray-200 md:flex md:justify-between md:items-center dark:border-neutral-700">
              ...
              <div>
                <div class="inline-flex gap-x-2">
                  <a class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="{{ route('admin-form-speciality') }}" wire:navigate>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
              <thead class="divide-y divide-gray-200 bg-gray-50 dark:bg-neutral-800 dark:divide-neutral-700">
                <tr>
                  <th scope="col" class="px-6 py-3 border-gray-200 text-start border-s dark:border-neutral-700">
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">195</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">99</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">96</span>
                      <span class="text-xs text-gray-500 dark:text-neutral-500">(11.40%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">32</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">25</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">24</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">46</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">42</span>
                ...
                <tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">30</span>
