                ...
                <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
                    <div>
                        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                            {{ __('Access Health care at your finger tips') }} 
                        ...
                        <div class="grid w-full gap-3 mt-7 sm:inline-flex">
                            ...
                            <a class="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-gray-800 bg-gray-300 border border-gray-200 rounded-lg shadow-sm gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#">
                                {{ __('Search for Doctors') }}
                            </a>
                        </div>
                    </div>
                    <div class="relative ms-4">
                        <img class="w-full rounded-md" src="{{ asset('images/doc.jpg') }}" alt="{{ __('Doctor using cellphone') }}">
